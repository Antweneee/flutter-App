...
class _ViewHairBooksState extends State<ViewHairBooks> {
  ...
  void showEditPopup(BuildContext context, bookid, services, appointmentDate, appointmentTime, Function() callback) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return EditHairBook(bookid: bookid, services: services, appointmentDate: appointmentDate, appointmentTime: appointmentTime, callback: callback);
      },
    );
  }
